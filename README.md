...
I tried implementing the `player everything.cfg` at main.c using system and fork, both gave me trouble (could not stablish connection for some reason, chances are
